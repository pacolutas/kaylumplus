			...
			<div class="app-header__inner">
				<a href="/" class="brand" aria-label="Home">
					<div class="brand__text">
						<h1 class="brand__title">PROYECTO KAYLUM</h1>
									...
									<section class="settings-section settings-section--wide">
										...
										>
											<span class="glass-option__content">
												...
												<span class="glass-option__description">Guardar cover.jpg junto a los archivos.</span>
											</span>
											<span class={`glass-option__chip ${downloadCoversSeperately ? 'is-active' : ''}`}>
												{downloadCoversSeperately ? 'Sí' : 'No'}
											</span>
										</button>
									</section>
									<section class="settings-section settings-section--wide">
